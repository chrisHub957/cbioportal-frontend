...
var config = {
    ...
    plugins: [
        new webpack.DefinePlugin({
            ...
            'ENV_FHIRSPARK_HOST': JSON.stringify(cleanAndValidateUrl(process.env.ENV_FHIRSPARK_HOST)),
            'ENV_FHIRSPARK_PORT': JSON.stringify(cleanAndValidateUrl(process.env.ENV_FHIRSPARK_PORT)),
        }),
